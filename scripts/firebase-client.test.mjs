...
function createIosContext({ standalone, supported = false } = {}) {
  ...
  const context = {
    ...
    firebase,
    navigator: { userAgent: "Mozilla/5.0 (iPhone)", platform: "iPhone", maxTouchPoints: 5, standalone, serviceWorker: { ready: Promise.resolve({ showNotification: async () => {} }) } },
